...
```bash
nix shell github:zortax/zlaunch/0.5.0
```
...
zlaunch also provides a Home Manager module for easy installation and configuration with Nix. The module is available as `zlaunch.homeManagerModules.default`.
